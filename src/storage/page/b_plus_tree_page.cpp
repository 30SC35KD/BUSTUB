...
//    else return (max_size_-1)/2+1;

if(IsLeafPage()) return max_size_ / 2; // return the minimum size of the leaf page
else
{
    return (max_size_ +1) / 2 ;
} // return the minimum size of the page
}
void BPlusTreePage::SetParentID(int p) {
    parent_id_=p;
}
void BPlusTreePage::SetPageID(int p) {
    page_id_=p; 
}
